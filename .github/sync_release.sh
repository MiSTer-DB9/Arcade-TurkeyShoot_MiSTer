...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-TurkeyShoot_MiSTer.git"
CORE_NAME=(Arcade-TurkeyShoot)
...
UPSTREAM_CORE_NAME=(Arcade-TurkeyShoot)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-TurkeyShoot.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-TurkeyShoot.rbf)
